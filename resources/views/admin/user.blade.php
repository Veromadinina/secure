    ...
    <div class='user-list w-full max-w-lg mx-auto bg-white rounded-xl shadow-xl flex flex-col py-4'>
        ...
        <div class="user-row flex flex-col items-center justify-between cursor-pointer  p-4 duration-300 sm:flex-row sm:py-4 sm:px-8 hover:bg-[#f6f8f9]">
            ...
            <div class="user-option mx-auto sm:ml-auto sm:mr-0">
                <a href={{route("admin-user-right",["user"=>$user->id])}} class="btn inline-block select-none no-underline align-middle cursor-pointer whitespace-nowrap px-4 py-1.5 rounded text-base font-medium leading-6 tracking-tight text-white text-center border-0 bg-[#e711a0] hover:bg-[#e711a0] duration-300" type="button">Admin</a>
            </div>  
            @else  
            <div class="user-option mx-auto sm:ml-auto sm:mr-0">
                <a href={{route("admin-user-right",["user"=>$user->id])}} class="btn inline-block select-none no-underline align-middle cursor-pointer whitespace-nowrap px-4 py-1.5 rounded text-base font-medium leading-6 tracking-tight text-white text-center border-0 bg-[#6911e7] hover:bg-[#590acb] duration-300" type="button">User</a>
            </div>  
            @endif
